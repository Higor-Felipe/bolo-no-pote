...
function renderizarCarrinho() {
      ...
      if (metodo === "pix") {
        qrcodeDiv.innerHTML = `
                            <div class="text-center p-4 bg-light rounded border shadow-sm">
                                ...
                                <!-- QR CODE FIXO -->
                                <img src="Images/qrcode-pix.png" class="img-fluid mb-3"
                                ...
                                <div class="d-flex align-items-center justify-content-center gap-2 mb-3">
                                    <p id="dado" class="chavePix mb-0 fw-bold text-primary">SUA_CHAVE_PIX</p>
  ...
  document.getElementById("btn-concluir").onclick = () => {
    ...
    if (metodo === "pix") {
      mensagem += `%0A✅ *CHAVE PIX:* SUA_CHAVE_PIX%0A\n`;
